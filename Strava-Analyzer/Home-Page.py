...
st.subheader('Step 1:')
st.image('Strava-Analyzer/pages/Steps/Step-1.png', caption='Log into Strava on the computer then go to the top right and click on settings',width=800)
st.subheader('Step 2:')
st.image('Strava-Analyzer/pages/Steps/Step-2.png', caption='Once in the settings menu, go over to the sidebar and click on the my account button',width=800)
st.subheader('Step 3:')
st.image('Strava-Analyzer/pages/Steps/Step-3.png', caption='Then once in the my account tab go down to the bottom of the page and click on get started under download or delete your account',width=800)
st.subheader('Step 4:')
st.image('Strava-Analyzer/pages/Steps/Step-4.png', caption='It will take you to this screen and then under download request click to request your archive',width=800)
st.subheader('Step 5:')
...
st.subheader('Step 6:')
st.image('Strava-Analyzer/pages/Steps/Step-6.png', caption='Download the file and then open activities.xlsx then click on file once you have opened the excel sheet',width=800)
st.subheader('Step 7:')
st.image('Strava-Analyzer/pages/Steps/Step-7.png', caption='Once you have gotten to the file screen, click save as and then save a copy of the excel file as a CSV file to your computer. Once this step is completed, the new file should read activities.CSV',width=800)
st.subheader('Step 8:')
